...
- **[MESSAGING.md](MESSAGING.md)** — one-liner, 25/100/250-word pitches, problem/solution, why-now, traction snapshot, competitive wedge, objection handling. Single source of truth.
- **[PERSONA-PLAYBOOKS.md](PERSONA-PLAYBOOKS.md)** — 1 page per persona: pain, trigger events, channel, hook module, ROI math.
- **[OBJECTION-HANDLING.md](OBJECTION-HANDLING.md)** — objection → rebuttal → proof artifact.
- **[OUTBOUND-SEQUENCES.md](OUTBOUND-SEQUENCES.md)** — 5-touch sequences (Day 0/3/7/14/21) per persona.
- **[PROOF-PACK.md](PROOF-PACK.md)** — demo scripts (5-min and 15-min), screenshots to capture, reference projects to show live.

---

## Live platform stats (May 2026)

> Pulled from production database. Refresh quarterly.

- **1,671** infrastructure projects
- **140** countries covered
- **1,483** high-confidence (≥70) verified projects
- **5,657** classified alerts
- **$246B+** indexed pipeline value
- **7** MDBs ingesting daily (WB, IFC, ADB, AfDB, EBRD, AIIB, IADB)
- **30+** specialised agents in production
- **20+** procurement portals automated
- **9** risk-signal categories tracked

---

## IMMEDIATE ACTIONS — week of May 1, 2026
...
| Apply — a16z Speedrun SR007 | **May 17, 2026** | [Apply](https://speedrun.a16z.com/apply) · [Our answers](applications/A16Z-SPEEDRUN.md) |
| Apply — Visa Africa Fintech Accelerator | **May 17, 2026** | [Apply](https://opportunitydesk.org/2026/04/14/visa-africa-fintech-accelerator-program-2026-cohort-6/) · [Our answers](applications/VISA-AFRICA-FINTECH.md) |
| Apply — Techstars Anywhere Fall 2026 | **June 10, 2026** | [Apply](https://www.techstars.com/accelerators/anywhere) · [Our answers](applications/TECHSTARS-ANYWHERE.md) |
| Activate — Microsoft for Startups | Rolling | [Apply](https://www.microsoft.com/en-us/startups) · [Our answers](applications/MICROSOFT-FOR-STARTUPS.md) |
| Activate — NVIDIA Inception | Rolling | [Apply](https://www.nvidia.com/en-us/startups/) · [Our answers](applications/NVIDIA-INCEPTION.md) |
| Activate — Google Cloud AI Tier | Rolling | [Apply](https://cloud.google.com/startup/ai) · [Our answers](applications/GOOGLE-CLOUD-AI.md) |
...
## Start LOI Outreach This Week

Send these four warm DMs **today**. All scripts in [loi-letters/](loi-letters/).

| Contact | Organization | Why warm | Template |
|---|---|---|---|
| Mpho Mutloane | AIIM | Africa PPP 2025 speaker | [Infra PE](loi-letters/loi-infra-pe-funds.md) |
| Stephan Jooste | Zutari | Africa PPP 2025 speaker, very active LinkedIn | [Consultants](loi-letters/loi-consultants.md) |
| Hatem Chahbani | World Bank | Named on Gambia $52.6M project press release | [DFI](loi-letters/loi-dfi-analysts.md) |
| Hanane Ait-Toudghi | L&T PT&D Africa | BD Director, public LinkedIn | [EPC](loi-letters/loi-epc-contractors.md) |

Mine 50+ more named contacts at zero cost:

- WB TTLs: `site:worldbank.org "task team leader" 2025`
- AfDB officers: `site:afdb.org "task team leader" 2025`
- IFC: `site:pressroom.ifc.org 2025`
- ADB: TAR docs at `adb.org/projects/documents`
- AIIB: `aiib.org/en/news-events/news`
- IADB: `iadb.org/en/news`
- EBRD: `ebrd.com/projects-finder`
...
- [MESSAGING.md](MESSAGING.md) — canonical pitch
- [PERSONA-PLAYBOOKS.md](PERSONA-PLAYBOOKS.md) — per-persona playbook
- [OBJECTION-HANDLING.md](OBJECTION-HANDLING.md) — objections + rebuttals
- [OUTBOUND-SEQUENCES.md](OUTBOUND-SEQUENCES.md) — 5-touch sequences
- [PROOF-PACK.md](PROOF-PACK.md) — demo scripts + screenshots
...
| [A16Z-SPEEDRUN.md](applications/A16Z-SPEEDRUN.md) | a16z Speedrun SR007 | May 17, 2026 |
| [VISA-AFRICA-FINTECH.md](applications/VISA-AFRICA-FINTECH.md) | Visa Africa Fintech | May 17, 2026 |
| [TECHSTARS-ANYWHERE.md](applications/TECHSTARS-ANYWHERE.md) | Techstars Anywhere Fall 2026 | June 10, 2026 |
| [ENTREPRENEUR-FIRST.md](applications/ENTREPRENEUR-FIRST.md) | Entrepreneur First London | Next cohort |
...
| File | For |
|---|---|
| [loi-dfi-analysts.md](loi-letters/loi-dfi-analysts.md) | WB, IFC, ADB, AfDB, EBRD, AIIB, IADB staff |
| [loi-epc-contractors.md](loi-letters/loi-epc-contractors.md) | Bechtel, Fluor, Vinci, L&T, CCC, Bouygues, Samsung C&T BD |
| [loi-infra-pe-funds.md](loi-letters/loi-infra-pe-funds.md) | AIIM, Actis, Brookfield, Macquarie, Meridiam, I Squared |
| [loi-project-finance-banks.md](loi-letters/loi-project-finance-banks.md) | Standard Bank, Absa, RMB, SocGen, StanChart, Citi |
| [loi-consultants.md](loi-letters/loi-consultants.md) | Zutari, Arup, KPMG, PwC, McKinsey GII, Mott MacDonald |
...
**Why now:**
Gemini 3 / GPT-5 class models make real-time document extraction, scoring and reporting tractable at near-zero marginal cost — the unit economics that justified MEED's analyst floor in 2015 don't survive 2026. World Bank committed $117B in FY2024; AfDB Mission 300 targets $300B by 2030. Buyers expect Bloomberg-grade self-service, not quarterly downloads.

---

## What still needs founder input

Sections marked **[FOUNDERS]** in every application file need:

1. Full names and roles
2. Personal backgrounds and relevant expertise
3. Authentic founding story (how you discovered this problem)
4. Incorporation details (country, date)
5. Any first-revenue / first-pilot signal worth quoting

These sections cannot be written for you — they need to be genuine.
