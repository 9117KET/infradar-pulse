...
Best first contacts (named, reachable, warm):

| Contact | Organization | Why Warm | Action |
|---|---|---|---|
| Mpho Mutloane | AIIM | Africa PPP 2025 speaker, public LinkedIn | [Send LinkedIn message](https://www.linkedin.com/in/mpho-mutloane-ca-sa-2674b349) · [Use template](loi-letters/loi-infra-pe-funds.md) |
| Stephan Jooste | Zutari | Africa PPP 2025 speaker, very active LinkedIn | [Send LinkedIn message](https://www.linkedin.com/in/stephanjooste/) · [Use template](loi-letters/loi-consultants.md) |
| Hatem Chahbani | World Bank | Named on public project press release | [Connect on LinkedIn](https://www.linkedin.com/in/hatem-chahbani-14b2216) · [Use template](loi-letters/loi-dfi-analysts.md) |
| Hanane Ait-Toudghi | L&T PT&D Africa | BD Director, public LinkedIn | [Connect on LinkedIn](https://www.linkedin.com/in/hanane-ait-toudghi-ing-38b051214) · [Use template](loi-letters/loi-epc-contractors.md) |

Mine 20+ more DFI names free:
- World Bank TTLs: `site:worldbank.org "task team leader" 2025`
- AfDB officers: `site:afdb.org "task team leader" 2025`
- IFC contacts: `site:pressroom.ifc.org 2025`

---

## All Files

### Accelerator Master Tracker
[ACCELERATORS.md](ACCELERATORS.md) - full program list with deadlines, status, and links

### LOI Contact Database
[LOI-TARGETS.md](LOI-TARGETS.md) - 25+ named organizations with contacts, email formats, and outreach channels
...
| File | For |
|---|---|
| [loi-dfi-analysts.md](loi-letters/loi-dfi-analysts.md) | World Bank, IFC, ADB, AfDB, EBRD staff |
| [loi-epc-contractors.md](loi-letters/loi-epc-contractors.md) | Bechtel, Fluor, Vinci, L&T, CCC BD teams |
| [loi-infra-pe-funds.md](loi-letters/loi-infra-pe-funds.md) | AIIM, Actis, I Squared, Pembani Remgro |
| [loi-project-finance-banks.md](loi-letters/loi-project-finance-banks.md) | Standard Bank, Absa, SocGen, Standard Chartered |
| [loi-consultants.md](loi-letters/loi-consultants.md) | Zutari, KPMG, Arup, McKinsey GII |
...
**Why now:**
GPT-4-class models make real-time document extraction and scoring tractable at near-zero marginal cost. World Bank committed $117B in 2024 - infrastructure intelligence demand has never been higher.

---

## What Still Needs Your Input

Every application has sections marked **[FOUNDERS]** that need:
1. Your full names and roles
2. Your personal backgrounds and relevant expertise  
3. Your authentic founding story (how you discovered this problem)
4. Your incorporation details (country, date)

These personal sections cannot be written for you - they need to be genuine.
