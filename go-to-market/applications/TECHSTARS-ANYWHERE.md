...
**Offer:** $220,000 ($120K for ~6% equity) + global mentor network + lifetime alumni access

---

## Why This Is a Strong Fit

- Designed for internationally-based and remote teams - no relocation required
- No visa pressure during the program itself
- Techstars has corporate partners in financial services and infrastructure
- Strong track record placing B2B SaaS into enterprise deals
- American-timezone sessions required but manageable
...
- Portfolio monitoring with AI-suggested adjacent projects
- AI intelligence digests generated every 4 hours
- Evidence verification and confidence scoring per project

We surface pre-tender signals 6-18 months before public RFP - the window that determines whether an EPC contractor can win a bid or an infrastructure fund can source a deal before it becomes competitive.
...
1. DFI analysts (World Bank, IFC, ADB, AfDB, EBRD)
2. Infrastructure PE funds (Brookfield, Actis, AIIM, I Squared, Macquarie)
3. EPC BD teams (Bechtel, Fluor, Vinci, L&T, CCC)
4. Project finance banks (Standard Bank, Absa, SocGen, Standard Chartered)
5. Strategy consultants (McKinsey GII, Arup, KPMG, PwC)
6. Government infrastructure ministries and SWFs

Primary beachhead: DFI analysts and smaller infrastructure PE funds who need the intelligence but cannot justify $50k+/year for incumbent platforms.
...
[FOUNDERS: Fill in both profiles. Emphasize technical and domain expertise. Note the AI-native approach to building with minimal headcount.]
...
1. **No relocation required.** As visa-constrained founders building in a pre-revenue stage, the fully remote structure of Anywhere removes a major operational constraint. We can participate fully without disrupting our current base of operations.

2. **Corporate partner access.** Techstars' financial services and enterprise corporate partners are exactly the institutional buyers we are trying to reach with pilot agreements and LOIs. A Techstars warm introduction to a corporate partner's infrastructure team is worth months of cold outreach.

3. **Structured mentorship on GTM.** The platform is built. The gap is go-to-market for a complex B2B enterprise product with long sales cycles. Techstars' mentor network for enterprise SaaS GTM is directly applicable to our next 90 days.

---

### What will you accomplish during the program?

By the end of the 13-week Techstars program (end of November 2026):
