# Techstars Anywhere Accelerator — Fall 2026 Application

**Deadline:** June 10, 2026
**Apply at:** https://www.techstars.com/accelerators/anywhere
**Program dates:** September – November 2026 (100% remote + 3 in-person offsites)
**Offer:** $220,000 ($120K for ~6% equity + $100K convertible note) + global mentor network + lifetime alumni access

---

## Why This Is a Strong Fit

- Designed for internationally-based, remote teams — no relocation required.
- No visa pressure during the program.
- Techstars has corporate partners in financial services and infrastructure — direct intro channel to our buyers.
- Strong track record placing B2B SaaS into enterprise pilots.
...
- Ask in plain English over the entire project graph.
- AI Market Report Builder (country / sector / tender / portfolio).
- Portfolio chat over tracked projects.
- Geospatial map, side-by-side comparison, AI digests every 4 hours.
- Satellite verification, contractor intel, delay prediction & early warning.

We surface pre-tender signals 6–18 months before public RFP — the window that determines whether an EPC contractor positions a winning bid or a fund sources a deal before it becomes competitive.

---

### Who are your customers?

Five primary personas (LOI templates deployed against each):

1. **Infrastructure PE funds** (Brookfield, Actis, AIIM, I Squared, Macquarie, DPI) — primary revenue beachhead.
2. **EPC BD teams** (Bechtel, Fluor, Vinci, L&T PT&D, CCC, Samsung C&T, POSCO, Bouygues) — primary revenue beachhead.
3. **Strategy & infra consultants** (McKinsey GII, Arup, KPMG, PwC, Mott MacDonald) — fast-cycle buyers.
4. **Project finance banks** (Standard Bank, Absa, SocGen, Standard Chartered, Sumitomo Mitsui).
5. **DFI analysts** (World Bank, IFC, ADB, AfDB, EBRD, AIIB, IADB) — primary credibility / LOI channel; longer revenue cycle.
...
- $246B+ in pipeline value indexed.
...
[FOUNDERS: Fill in both profiles. Emphasise technical and domain expertise. Note the AI-native build approach — two founders shipped 30+ agents and 10 product modules without external engineering hires, on a Lovable AI / Supabase / Vercel stack.]

---

### Why Techstars Anywhere?

1. **No relocation required.** Fully remote structure removes a major operational constraint for visa-constrained founders.

2. **Corporate partner access.** Techstars financial services and enterprise corporate partners are exactly the institutional buyers we are converting on pilots and LOIs. A Techstars warm intro to a corporate partner's infrastructure team is worth months of cold outreach.

3. **Structured GTM mentorship.** The platform is built. The constraint is enterprise GTM. Techstars' enterprise SaaS GTM mentor network is directly applicable to our next 90 days of pilot conversion.

---

### What will you accomplish during the program?
