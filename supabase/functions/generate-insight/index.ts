...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are InfradarAI's senior infrastructure analyst. You write insightful, data-driven articles about global infrastructure development.
