...
BEGIN
  ...
  INSERT INTO public.project_verification_log (project_id, action, reason, performed_by) VALUES (v_project_id, 'auto_published', COALESCE(p_reason, 'Auto-published from official registry ingest'), NULL);
