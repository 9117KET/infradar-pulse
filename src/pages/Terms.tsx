    ...
    <div className="py-20">
      <div className="mx-auto max-w-3xl px-4 sm:px-6">
        ...
        <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
          ...
          <p>Intelligence data provided by Infradar is for informational purposes and should not be the sole basis for investment decisions. Users acknowledge that data is derived from multiple sources and may contain estimated or projected values.</p>
          <h2 className="font-serif text-xl font-bold text-foreground pt-4">4. Limitation of Liability</h2>
          <p>Infradar shall not be liable for indirect, incidental, or consequential damages arising from use of the platform or reliance on intelligence data.</p>
        </div>
      </div>
    </div>
  );
