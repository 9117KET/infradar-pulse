...
export default function Research() {
  ...
  const handleExportPDF = useCallback(async () => {
    ...
    y += 8;
    addLine();
    addText('Report generated by InfradarAI Intelligence Platform', 8, false, [150, 150, 150]);

    // Stamp diagonal "Licensed to {email}" watermark on every page so a
    // leaked PDF can be traced back to the account that exported it.
