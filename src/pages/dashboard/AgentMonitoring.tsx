...
const AGENTS = [
  ...
  { type: 'contact-finder', name: 'Contact Finder', icon: Phone, schedule: 'Every 3 hours', fn: agentApi.runContactFinder, description: 'Discovers contractor emails, procurement contacts & key personnel' },
];
