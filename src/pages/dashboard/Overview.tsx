import { PROJECTS, formatValue } from '@/data/projects';
import { ALERTS } from '@/data/alerts';
import { TrendingUp, ShieldCheck, Activity, Clock, AlertTriangle } from 'lucide-react';
...
const KPIs = [
  ...
  { label: 'Avg confidence', value: `${Math.round(PROJECTS.reduce((s, p) => s + p.confidence, 0) / PROJECTS.length)}%`, delta: '+1.2%', icon: TrendingUp, trend: 'up' as const },
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {KPIs.map(k => (
          <div key={k.label} className="glass-panel rounded-xl p-5">
            ...
            <div className="text-2xl font-serif font-bold">{k.value}</div>
