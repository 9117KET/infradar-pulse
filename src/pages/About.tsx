    ...
    <div className="py-20">
      <div className="mx-auto max-w-3xl px-4 sm:px-6">
        ...
        <div className="prose prose-invert max-w-none space-y-4 text-muted-foreground">
          <p>Infradar delivers verified infrastructure intelligence for decision-makers operating across 14 global regions, from fast-growing emerging markets to major OECD infrastructure programs.</p>
