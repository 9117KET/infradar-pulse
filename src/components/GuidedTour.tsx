...
const ALL_STEPS: TourStep[] = [
  ...
  { target: 'nav-agents', title: 'Intelligence Agents', description: 'Manage and trigger AI research agents for specialized intelligence gathering.', position: 'right', minRole: 'researcher' },
