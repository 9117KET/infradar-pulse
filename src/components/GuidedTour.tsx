...
const ALL_STEPS: TourStep[] = [
  ...
  { target: 'nav-ask', title: 'Ask AI', description: 'Search the platform in natural language and get direct answers grounded in live project intelligence.', position: 'right' },
  { target: 'nav-alerts', title: 'Alerts', description: 'Monitor critical project changes, tender movements, risk events, and market signals.', position: 'right' },
  ...
  { target: 'nav-portfolio', title: 'My Portfolio', description: 'Track priority projects, manage notes, and focus on the opportunities that matter most.', position: 'right' },
  { target: 'nav-chat', title: 'Portfolio Chat', description: 'Ask AI questions about your tracked projects in natural language.', position: 'right' },
  ...
  { target: 'nav-countries', title: 'Country Intelligence', description: 'Country-by-country project portfolios, risk profiles, and pipeline momentum.', position: 'right' },
  { target: 'nav-tenders', title: 'Tenders & Awards', description: 'Track contract awards, cancellations, procurement changes, and tender-related alerts.', position: 'right' },
  { target: 'nav-summaries', title: 'Reports & Briefings', description: 'Generate AI-powered market reports, executive summaries, and intelligence briefings.', position: 'right' },
  { target: 'nav-research', title: 'AI Research Hub', description: 'Type any query and watch AI agents research projects in real time with visual progress tracking.', position: 'right', minRole: 'researcher' },
  { target: 'nav-evidence', title: 'Evidence & Verification', description: 'Multi-source evidence layers: satellite imagery, filings, news, and partner data.', position: 'right', minRole: 'researcher' },
  { target: 'nav-agents', title: 'Intelligence Agents', description: 'Trigger AI research agents (subscription or trial required to run).', position: 'right', minRole: 'researcher' },
  ...
  { target: 'nav-insights', title: 'Insights & Briefings', description: 'AI-generated intelligence briefings and sector analysis reports.', position: 'right', minRole: 'researcher' },
